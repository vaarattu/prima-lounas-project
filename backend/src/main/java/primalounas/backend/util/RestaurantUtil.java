package primalounas.backend.util;
...
import primalounas.backend.model.RestResponse;
import primalounas.backend.model.RestaurantCourse;
import primalounas.backend.model.RestaurantDay;
